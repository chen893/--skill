...
- `novel/continuity/timeline.md`
- `novel/continuity/constraints.md`
- `novel/continuity/open-threads.md`
- `novel/continuity/issues.md`
- 相关 `novel/bible/**`
- 目标章节：优先读摘要，必要时精准回读正文

## 输出（必须落盘）

- `novel/reports/continuity/report-YYYYMMDD.md`
- 必要时更新：`novel/continuity/issues.md`（把冲突变成可追踪待办）
