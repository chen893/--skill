...
2. 读取或创建对应文件：
   - 人物：`novel/bible/characters/char-*.md`
   - 地点：`novel/bible/locations/loc-*.md`
   - 势力：`novel/bible/factions/fac-*.md`
   - 物品：`novel/bible/items/item-*.md`
   - 体系规则：`novel/bible/systems/sys-*.md`
